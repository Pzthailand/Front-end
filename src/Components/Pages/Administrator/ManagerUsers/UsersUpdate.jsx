...
import { _ReadUsers, _UpdateUsers,_ChangeStatus,_ChangeRole } from '../../../Functions/ManagerUser';
...
const UsersUpdate = () => {
    ...
    useEffect(() => {
        const loadData = async () => {
            setLoading(true);
            try {
                const res = await _ReadUsers(id,authtoken);
                setForm({
                    id : res.data._id,
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await _UpdateUsers(id,authtoken,formWithImageData);
